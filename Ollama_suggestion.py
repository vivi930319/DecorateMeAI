...
install_api_error_handling(app, "ollama-suggestion")
...
MAP_EYE    = {"downturned": "下垂眼", "round": "圓眼", "peach_almond": "桃杏眼",
              "slender": "細長眼", "phoenix": "鳳眼", "unknown": "未知眼型"}
...
EYE_LOGIC      = {"圓眼": "眼神圓潤清澈", "下垂眼": "眼尾柔和下垂", "細長眼": "眼神嫵媚狹長",
                  "鳳眼": "眼尾俐落上揚", "桃杏眼": "眼型柔和明亮"}
NOSE_LOGIC     = {"標準鼻": "鼻型比例勻稱", "寬鼻": "鼻翼大氣飽滿", "未知鼻型": "依照鼻型自然修飾"}
LIP_LOGIC      = {"花瓣唇": "唇峰立體飽滿", "微笑唇": "嘴角天然上揚", "厚唇": "唇部感性飽滿", "薄唇": "唇線俐落清秀"}
