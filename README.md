...
| 服務 | URL | 狀態 | 跑在哪 |
|------|-----|------|--------|
| 前端 | http://127.0.0.1:5500 | ✅ 本機 | Isa 電腦 dev_server.py |
...
| ollama_suggestion | https://possibly-polyester-bargains-transcript.trycloudflare.com | ✅ Cloudflare | 黃姵錚 Mac |
| replicate_render | — | ⏳ 等組員 | 組員電腦 → Cloudflare |

本機 8001、8002 已不需要啟動，前端直接打 Cloud Run。
