...
| 部位 | 隨機猜 | ① 規則式（線上現況） | ② ROI CNN | ③ ______ | 規格書門檻 |
|---|---|---|---|---|---|
| face_shape | 0.200 | 0.326 | **0.475** | | 0.70 |
| brow_shape | 0.333 | 0.333 | **0.589** | | 0.75 |
| eye_shape | 0.143 | 0.143 | **0.378** | | 0.70 |
| nose_shape | 0.333 | 0.354 | **0.666** | | 0.70 |
| lip_shape | 0.200 | 0.331 | **0.452** | | 0.70 |

**目前沒有任何方案達標。** ② 全面優於 ①，但仍低於門檻。
